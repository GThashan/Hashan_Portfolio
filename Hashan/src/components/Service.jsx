...
export default function Service() {
  return (
    <div className='bg-[#0f172a]   mx-4 mt-4 p-10 shadow-lg rounded-lg'>
      <h1 className='font-bold text-[20px] mb-4 text-white'>My Services</h1>
      <p className='text-center my-3 text-white'>I'm here to help if you're searching for a product designer to bring your idea to life or a design partner to help take your business to the next level.</p>
